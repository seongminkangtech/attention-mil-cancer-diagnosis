...
class TestPredictEndpoint:
    ...
    def test_predict_without_file(self):
        ...
        request_data = {"image_paths": [], "confidence_threshold": 0.5}
    ...
    def test_predict_with_invalid_file_type(self):
        ...
        # 잘못된 이미지 경로
        request_data = {"image_paths": ["/tmp/test.txt"], "confidence_threshold": 0.5}
    ...
    def test_predict_with_large_file(self):
        ...
        request_data = {"image_paths": many_paths, "confidence_threshold": 0.5}
...
class TestAPIValidation:
    ...
    def test_file_size_validation(self):
        ...
        for count in test_counts:
            ...
            request_data = {"image_paths": image_paths, "confidence_threshold": 0.5}
...
class TestAPIErrorHandling:
    ...
    def test_server_error_handling(self):
        ...
        # 잘못된 요청으로 서버 오류 유발
        request_data = {"image_paths": None, "confidence_threshold": 0.5}  # 잘못된 타입
